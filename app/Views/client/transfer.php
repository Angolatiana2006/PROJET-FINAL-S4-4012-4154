...
<div class="client-container">
    ...
    <div class="card-form">
        ...
        <div class="fee-info">
            ...
            Des frais de transfert s'appliquent selon le montant
        </div>

        <form action="<?= base_url('client/do-transfer') ?>" method="POST">
            <?= csrf_field() ?>
            ...
            <div class="form-group">
                <label>
                    <i class="fas fa-money-bill-wave"></i> Montant à transférer (Ar)
                </label>
                <input type="number" 
                       class="form-control-custom" 
                       name="amount" 
